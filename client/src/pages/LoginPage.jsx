...
const LoginPage = () => {
  ...
  const handleTestLogin = async () => {
    // Set the token and user data directly for testing
    const token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiI2OGM4MTg4YTkxMTFhMmVlMGFhNmZiMjQiLCJlbWFpbCI6InRlc3RAZXhhbXBsZS5jb20iLCJpYXQiOjE3NTc5NDQ0MDUsImV4cCI6MTc1ODAzMDgwNX0.lPYpRum-GmPzCgTsSUsofWmtJd88U-SmfLPCfEivT3o';
    const user = {
      _id: '68c8188a9111a2ee0aa6fb24',
